...
A coleta e uso de informações são conforme a utilização do usuários, os dados são criptografados e não possuem nenhum tipo de acesso após a criação, apenas o usuário consgue vê-lo no aplicativo.
